...
public class kitapfonks {
	...
	public static void veriGiris(List<String> ad, List<Byte> sayfas, List<Byte> tarih, List<Byte> fiyat,
			List<String> yazar, List<String> tur) {
		Scanner giris = new Scanner(System.in);
		System.out.println("Kitap adı giriniz: ");
		ad.add(giris.next());
		System.out.println("Sayfa sayısı giriniz: ");
	    sayfas.add((byte) giris.nextByte());
		System.out.println("Tarih giriniz: ");
		tarih.add((byte) giris.nextByte());
		System.out.println("Fiyat giriniz: ");
		fiyat.add((byte) giris.nextByte());
	...
	public static void Listeleme(List<String> ad, List<Byte> sayfas, List<Byte> tarih, List<Byte> fiyat,
			List<String> yazar, List<String> tur) {
	...
	public static void arananAd(List<String> ad, List<Byte> sayfas, List<Byte> tarih, List<Byte> fiyat,
		...
		if(indis>=0) {
			...
			System.out.println("Aradığınız isim listede yok!");
	}
	...
	public static void duzelt(List<String> ad, List<Byte> sayfas, List<Byte> tarih, List<Byte> fiyat,
		...
		if(indis>=0) {
			...
			System.out.println("Yeni kitap türü giriniz: ");
